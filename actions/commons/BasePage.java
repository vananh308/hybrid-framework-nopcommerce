...
public class BasePage {
	...
	public void selectItemInCustomDropdown(WebDriver driver, String parentXpath, String childXpath,
			String exxpectedTextItem) {
		getWebElement(driver, exxpectedTextItem).click();
		sleepInSecond(1);
		...
		for (WebElement item : allItems) {
			if (item.getText().trim().equals(exxpectedTextItem)) {
	...
	public String getHexaColorFrom(String rgbaValue) {
	...
	public UserCustomerInfoPageObject openCustomerInforPage(WebDriver driver) {
